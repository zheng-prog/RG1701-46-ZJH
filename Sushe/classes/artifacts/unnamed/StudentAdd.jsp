...
function mycheck(){
   ...
   alert("请输入学号！"); 
   }else if(isNull(form1.Student_Password.value)){
   alert("请输入密码！");
   }else if(isNull(form1.Student_Password2.value)){
   alert("请输入重复密码！");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top"><form id="form1" name="form1" method="post" action="StudentAddSave.action" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="Student_Username" type="text" class="mini-textbox" id="Student_Username"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>密码：</td>
                    <td align="left"><input name="Student_Password" type="password" class="mini-password" id="Student_Password"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>重复密码：</td>
                    <td align="left"><input name="Student_Password2" type="password" class="mini-password" id="Student_Password2"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>姓名：</td>
                    <td align="left"><input name="Student_Name" type="text" class="mini-textbox" id="Student_Name"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="Student_Class" type="text" class="mini-textbox" id="Student_Class"></td>
                  </tr>
                  <tr>
                  	<td>&nbsp;</td>
                    <td align="left">
                    	<a href="javascript:mycheck();" class="mini-button" name="button" id="button">添加学生</a>
                      &nbsp;&nbsp;
