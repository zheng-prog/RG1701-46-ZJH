...
public class LogAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(session.getAttribute("id")==null){
			out.print("<script language='javascript'>alert('请重新登录！');window.location.href='View/login.jsp';</script>");
		...
		//跳转
		out.print("<script language='javascript'>alert('缺寝登记成功！');window.location.href='MyStudent.action';</script>");
		out.flush();out.close();return null;
