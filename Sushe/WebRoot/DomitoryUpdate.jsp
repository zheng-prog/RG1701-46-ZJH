...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top"><form id="form1" name="form1" method="post" action="DomitoryUpdateSave.action" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="Domitory_Name" type="text" class="mini-textbox" id="Domitory_Name" value="<s:property value='cnbean.Domitory_Name'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>寝室类型：</td>
                    <td align="left"><input name="Domitory_Type" type="text" class="mini-textbox" id="Domitory_Type" value="<s:property value='cnbean.Domitory_Type'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>人数：</td>
                    <td align="left"><input name="Domitory_Number" type="text" class="mini-textbox" id="Domitory_Number" value="<s:property value='cnbean.Domitory_Number'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>电话：</td>
                    <td align="left"><input name="Domitory_Tel" type="text" class="mini-textbox" id="Domitory_Tel" value="<s:property value='cnbean.Domitory_Tel'/>"></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="left"><a href="javascript:mycheck();" name="button" id="button" class="mini-button">修改宿舍</a>
                      &nbsp;&nbsp;
